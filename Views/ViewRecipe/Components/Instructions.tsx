...
const ignoreWords = ["half", "the", "all", "by", "cut", "inch", "a", "be", "using", "cook", "if", "will", "as", "see", "note", "then", "at", "need", "tablespoons", "room", "temperature", "tsp", "tbsp", "teaspoon", "tablespoon", "cups", "and", "into", "cup", "to", "medium", "slices", "or", "your", "about", "for", "more", "pinch", "of", "each", "two", "large", "medium", "small"]
