...
/**
 * Creates a screen that displays the see Privacy Policy section
 * @param modalVisible whether or not the modal is visible or not
 * @param setModalVisible sets the visibility of the modal
 */
export function PrivacyPolicy({ modalVisible, setModalVisible }: { modalVisible: boolean, setModalVisible: React.Dispatch<React.SetStateAction<boolean>> }) {
        ...
        <Modal visible={modalVisible} setVisible={setModalVisible} headerTitle="Appetite" headerButton="Done">
            <ScrollView style={{ height: "100%" }}>
                <View style={styles.container}>
                    <Text style={styles.title} variant="headlineMedium">Privacy Policy</Text>
